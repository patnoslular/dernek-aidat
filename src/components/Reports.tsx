...
export default function Reports({ members, transactions, duesRules }: ReportsProps) {
  ...
  // Beklenen toplam aidat ve toplam borç hesabı
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-white tracking-tight">Finansal & Üye Analizi</h2>
          <p className="text-slate-500 text-sm">Derneğinizin mali durumunu ve üye katılımını detaylı grafiklerle takip edin.</p>
        </div>
        <button className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors border border-slate-700">
        ...
        <div className="glass-card p-6 flex flex-col justify-between">
          ...
          <div className="mt-6 p-4 bg-indigo-600/10 border border-indigo-500/20 rounded-xl">
            <p className="text-[10px] text-indigo-300 font-medium leading-relaxed italic">
              * Tahsilat oranı aktif üyelerin cari yıl ödemeleri üzerinden hesaplanmıştır.
            </p>
          </div>
        </div>
      </div>
